...
const MenuItem_t menuNull PROGMEM = { (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, (void *)NULL, NULL };

const MenuItem_t * menuLastInvokedItem = &menuNull;
const MenuItem_t * menuCurrentItem     = &menuNull;
const MenuItem_t * menuPreviousItem    = &menuNull;
